...
#
# Dit script gaat ervan uit dat het 5 minuten na ieder uur wordt uitgevoerd (bijv. via cron).
# Het bepaalt op basis van de huidige tijd (of de vorige uur als de minuut < 5 is)
...
#   /var/private/opnames/omroep land van cuijk/<YYYY-MM-DD>/<HH>.mp3
#
# Logging vindt plaats in /var/private/logs/download_omroeplvc.log
#

set -euo pipefail

# Configuratie
LOG_FILE="/var/private/logs/download_omroeplvc.log"
LOCAL_BASE="/var/private/opnames/omroep land van cuijk"
...
# We gaan ervan uit dat het script 5 minuten na ieder uur draait.
